...
function Install-azurite {
    ...
    #Write-Host "NodeJSVersionedInstalledPath: " + $NodeJSVersionedInstalledPath
    Write-Host "NodeJSGenericInstalledPath: " + $NodeJSGenericInstalledPath
    #Write-Host "NodeJSInitBatchFile: " + $NodeJSInitBatchFile
    ...
    #Write-Host "npmCmdPath: " + $npmCmdPath
    Push-Location
