...
* Aggregate pushdown C API [#4176](https://github.com/TileDB-Inc/TileDB/pull/4176)
...
* Remove default operation type from query condition set membership API [#4390](https://github.com/TileDB-Inc/TileDB/pull/4390)
...
* MEAN and NULL_COUNT capi/cppapi wraps [#4443](https://github.com/TileDB-Inc/TileDB/pull/4443)
...
* Update the Google Cloud Storage SDK to its latest version. [#4031](https://github.com/TileDB-Inc/TileDB/pull/4031)
