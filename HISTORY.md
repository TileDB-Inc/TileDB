...
## Improvements
* Add support for stats with serialized query objects [#2321](https://github.com/TileDB-Inc/TileDB/pull/2321)
* replace ReadFromOffset with ReadRange in GCS::read() to avoid excess gcs egress traffic [#2279](https://github.com/TileDB-Inc/TileDB/pull/2279)
* REST and serialization support for the new array timestamp start/end ranges [#2293](https://github.com/TileDB-Inc/TileDB/pull/2293)
* Support for var length and nullable attributes [#2271](https://github.com/TileDB-Inc/TileDB/pull/2271)
...
## Deprecations
* Deprecate all *_with_key APIs. [#2308](https://github.com/TileDB-Inc/TileDB/pull/2308)
* Deprecate all `*_with_key` APIs. [#2245](https://github.com/TileDB-Inc/TileDB/pull/2245)
...
* Fix ch7908: missing assignment for adjust_range_oob_func_ in a Dimension constructor [#2314](https://github.com/TileDB-Inc/TileDB/pull/2314)
* Fix incorrect offset count with incomplete serialized queries and `sm.var_offsets.extra_element` [#2306](https://github.com/TileDB-Inc/TileDB/pull/2306)
* Fix for missing error response data when a query submit fails [#2294](https://github.com/TileDB-Inc/TileDB/pull/2294)
* Incorrect tile number calculation for global writes [#2295](https://github.com/TileDB-Inc/TileDB/pull/2295)
* Fixes de-dupe coordinates for unordered reads with hilbert cell order [#2292](https://github.com/TileDB-Inc/TileDB/pull/2292)
* Fix buffer arguments in unit-curl.cc [#2287](https://github.com/TileDB-Inc/TileDB/pull/2287)
* Fix false error message when opening an array with a string dimension and hilbert cell order [#2288](https://github.com/TileDB-Inc/TileDB/pull/2288)
* Fixing incorrect calculation in hilbert ranges [#2270](https://github.com/TileDB-Inc/TileDB/pull/2270)
* Treating `std::vector` like an array; accessing an element that's not present to get its address. [#2276](https://github.com/TileDB-Inc/TileDB/pull/2276)
...
### C API
* Added tiledb_ctx_get_stats and tiledb_query_get_stats [#2322](https://github.com/TileDB-Inc/TileDB/pull/2322)
* Added tiledb_array_set_open_timestamp_start and tiledb_array_get_open_timestamp_start [#2281](https://github.com/TileDB-Inc/TileDB/pull/2281)
* Added tiledb_array_set_open_timestamp_end and tiledb_array_get_open_timestamp_end [#2281](https://github.com/TileDB-Inc/TileDB/pull/2281)
...
### C++ API
* Added Context::stats and Query::stats [#2322](https://github.com/TileDB-Inc/TileDB/pull/2322)
* Make QueryCondition constructor from tiledb_query_condition_t* public [#2286](https://github.com/TileDB-Inc/TileDB/pull/2286)
* Added Array::set_open_timestamp_start and Array::open_timestamp_start [#2281](https://github.com/TileDB-Inc/TileDB/pull/2281)
* Added Array::set_open_timestamp_end and Array::open_timestamp_end [#2281](https://github.com/TileDB-Inc/TileDB/pull/2281)
