...
.PARAMETER EnableTileAi
Enables building with the tile.ai filesystem backend.
...
# Set TileDB tile.ai filesystem flag
$UseTileAi = "OFF"
if ($EnableTileAi.IsPresent) {
    $UseTileAi = "ON"
}
