...
.Parameter EnableWdocumentation
Enable the use of -Wdocumentation during build.
...
$Wdocumentation = "OFF"
if ($EnableWdocumentation.IsPresent) {
    $Wdocumentation = "ON"
}
