...
message("tiledb project, CMAKE_COMMAND is ${CMAKE_COMMAND}")
message("tiledb project, PROJECT_SOURCE_DIR is ${PROJECT_SOURCE_DIR}")
message("tiledb project, TILEDB_USE_GCS_TOOLCHAIN is ${TILEDB_USE_GCS_TOOLCHAIN}")
...
ExternalProject_Add(tiledb
  ...
  PATCH_COMMAND
    ...
    #${CMAKE_COMMAND} -E echo "FORWARD_EP_CMAKE_ARGS is ${FORWARD_EP_CMAKE_ARGS}, CMAKE_MODULE_PATH is ${CMAKE_MODULE_PATH}, VCPKG_ROOT is $$env{VCPKG_ROOT}"
    #${CMAKE_COMMAND} -E echo "FORWARD_EP_CMAKE_ARGS is ${FORWARD_EP_CMAKE_ARGS}, CMAKE_MODULE_PATH is ${CMAKE_MODULE_PATH}, VCPKG_ROOT is ENV{VCPKG_ROOT}"
  # appears that withOUT CMAKE_ARGS build step is assuming 'make'....
#  CMAKE_ARGS
...
#    ${CMAKE_COMMAND} -E env VCPKG_ROOT=${CMAKE_BINARY_DIR}/tdb.vcpkg/vcpkg ${CMAKE_COMMAND}         -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${TILEDB_USE_GCS_TOOLCHAIN} ${PROJECT_SOURCE_DIR}
#                                                                           ${CMAKE_COMMAND}         -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${TILEDB_USE_GCS_TOOLCHAIN} ${PROJECT_SOURCE_DIR}
                                                                           ${CMAKE_COMMAND}         -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS}                             ${PROJECT_SOURCE_DIR}
#    ${CMAKE_COMMAND} -E env VCPKG_ROOT=${CMAKE_BINARY_DIR}/externals/src/ep_gcssdk/cmake-out/vcpkg_installed ${CMAKE_COMMAND}         -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${TILEDB_USE_GCS_TOOLCHAIN} ${PROJECT_SOURCE_DIR}
#    devenv /debugexe                                                        ${CMAKE_COMMAND} -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${PROJECT_SOURCE_DIR}
#    devenv ${CMAKE_COMMAND} -E env VCPKG_ROOT=${CMAKE_BINARY_DIR}/tdb.vcpkg/vcpkg ${CMAKE_COMMAND} -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${TILEDB_USE_GCS_TOOLCHAIN} ${PROJECT_SOURCE_DIR}
#    devenv ${CMAKE_COMMAND} -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${PROJECT_SOURCE_DIR}
#    ${CMAKE_COMMAND} -E env VCPKG_ROOT=${CMAKE_BINARY_DIR}/tdb.vcpkg/vcpkg ${CMAKE_COMMAND} --trace -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${TILEDB_USE_GCS_TOOLCHAIN} ${PROJECT_SOURCE_DIR}
#    ${CMAKE_COMMAND} -E env VCPKG_ROOT=${CMAKE_BINARY_DIR}/tdb.vcpkg/vcpkg ${CMAKE_COMMAND} --trace-expand -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${TILEDB_USE_GCS_TOOLCHAIN} ${PROJECT_SOURCE_DIR}
#    ${CMAKE_COMMAND} -E env VCPKG_ROOT=${CMAKE_BINARY_DIR}/tdb.vcpkg/vcpkg ${CMAKE_COMMAND} --debug-find -DTILEDB_SUPERBUILD=OFF ${INHERITED_CMAKE_ARGS} ${FORWARD_EP_CMAKE_ARGS} ${TILEDB_USE_GCS_TOOLCHAIN} ${PROJECT_SOURCE_DIR}
  INSTALL_COMMAND ""
